...
const styles = {
  ...
  bgGradientColor:
    "bg-gradient-to-br from-gray-50 via-gray-100 to-gray-200 dark:from-neutral-800 dark:to-black",
  ...
  absoluteCenter:
    "absolute top-[50%] right-[50%] translate-x-[50%] -translate-y-[50%]",
  // absoluteCenter: "absolute top-[50%] right-[50%]"

  // text font and sizes
  title: "text-4xl sm:text-6xl mb-4 font-bold",
  subTitle: "",
  ...
  // elements
  buttonRedBig:
    "rounded-lg border-[3px] border-my-red text-my-red py-2 px-4 text-normal font-bold ",
  buttonBlueBig:
    "rounded-lg border-[3px] border-my-blue text-my-blue py-2 px-4 text-normal font-bold ",
  btn: "bg-gray-800 text-white rounded-xl w-[160px] h-[36px] leading-9 shadow-md ",
  buttonGrayBig:
    "h-14 w-80 rounded-xl bg-gray-700 text-white leading-10 text-base mt-14 mb-14 shadow-md hover:bg-gray-600",

  // form
  formElementMarginBottom: "mb-3",
  formLabel: "text-sky-300 text-left block mb-1 font-bold",
  formLabelDark:
    "text-my-gray dark:text-neutral-300 text-left block mb-1 font-bold",
  formInput:
    "w-full bg-gray-400 appearance-none border-2 border-sky-600 rounded-sm py-2 px-4 text-gray-700 leading-tight focus:outline-none focus:bg-gray-400 focus:border-sky-500",
  formInputDark:
    "px-2 w-full rounded-sm h-8 bg-neutral-100 dark:bg-neutral-800 border border-neutral-400 dark:border-neutral-600 text-black dark:text-gray-100 focus:outline outline-2 focus:outline-blue-300 dark:focus:outline-blue-300",
  formTextareaDark:
    "px-2 py-1 w-full rounded-sm bg-neutral-100 dark:bg-neutral-800 border border-neutral-400 dark:border-neutral-600 text-black dark:text-gray-100 focus:outline outline-2 focus:outline-blue-300 dark:focus:outline-blue-300",
